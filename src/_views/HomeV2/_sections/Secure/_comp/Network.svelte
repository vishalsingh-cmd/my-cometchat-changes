...
<div
  class={cn(
    ['relative', 'border-b border-l border-r border-[#FAFAFF1A]'],
    ['sm:border-r-0'],
    ['lg:border-b-0'],
    [className]
  )}
>
  ...
  <SecureDecCircle position="topRight" className="sm:hidden" />
  <SecureDecCircle position="bottomLeft" />
  <SecureDecCircle position="bottomRight" className="sm:hidden" />
</div>
