...
{#if block}
  <div
    ...
    class={cn(
      'wrap sticky top-[80px] mb-44 hidden h-[300px] w-full max-w-[500px] flex-col gap-3 space-y-3 overflow-clip rounded-3xl border border-gray-4 bg-[#F8F8F8] p-5 text-black shadow-lg lg:block'
    )}
  >
