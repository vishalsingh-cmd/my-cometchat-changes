<script lang="ts">
  ...
  import type { MultilinkStoryblok, AssetStoryblok } from '$types/bloks';
...
<div class="w-full max-w-[640px]">
  <Media media={illustration} class="mb-6 md:mb-12" />
  <div class="max-w-[528px] font-sans text-xl text-gray-12">
