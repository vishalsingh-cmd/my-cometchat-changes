                  ...
                  <Accordion id={title}>
                    ...
                    <div id="line" class="col-span-6 w-full items-center justify-center">
                      {#each lines as item, i}
                        ...
                        >
                          <div class="col-span-6 flex w-full flex-row items-center justify-between">
                            <div
                              class="col-span-4 ml-12 flex flex-row items-start justify-start gap-3 self-center py-5 text-lg/snug font-medium tracking-wide"
                            >
                              <span>
                                {name}
                              </span>
                            ...
                            <div class=" col-span-2">
                              {#if active_tab === 0}
                                <div class="w-full bg-purple-2 md:bg-purple-9">
                                  {#if scale === 'no'}
                              ...
                              {:else}
                                <div class="w-full bg-white md:bg-purple-9">
                                  <!-- same for the grow -->
                                  {#if grow === 'no'}
                                    <div class="col-span-2 flex w-full items-center justify-center">
                                      <span class="self-center">-</span>
