<script lang="ts">
  ...
  import type { PricingPlanEnhancementScaleStoryblok } from '$types/bloks';

  export let block: PricingPlanEnhancementScaleStoryblok | undefined;
</script>
    ...
    <div class={cn('flex flex-col gap-6')}>
      <div class={cn('flex flex-col gap-1 text-gray-12 md:gap-3')}>
        ...
        <div class={cn('text-2xl/tighter font-semibold')}>
          <span class="text-brand-9"> {price} </span>
        </div>
